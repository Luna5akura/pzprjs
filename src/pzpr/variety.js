...
(function() {
	...
	(function(Genre, obj) {
		...
		},
		{
			...
			"domino-search": [0, 0, "多米诺搜寻", "Domino Search", "domino_search"],
			...
			fourwinds: [0, 0, "フォーウィンズ", "Four Winds"],
			fourwindswithparks: [0, 0, "フォーウィンズ", "Four Winds with Parks"],
			...
			japanesesumswithzeroes: [0, 0, "数字和（0あり）", "Japanese Sums with Zeroes", "japanesesums"],
			japanese_arrows: [0, 0, "ジャパニーズアローズ", "Japanese Arrows"],
			consecutivekakuro: [0, 1, "連続カックロ", "Consecutive Kakuro", "kakuro"],
			...
			lostspeech: [0, 0, "Lost Speech", "Lost Speech"],
			...
			"slovak-sums": [0, 0, "Slovak Sums", "Slovak Sums"],
			...
			"statuepark-aux": [0, 0, "図形の編集", "Edit shape", "statuepark"],
