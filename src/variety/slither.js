...
(function(pidlist, classbase) {
	...
	"MouseEvent@wolvesandsheepfences": {
		inputModes: {
	...
	Graphic: {
		...
		paint: function() {
			...
			this.drawLines();
			this.drawBaseMarks();
			if (this.pid === "wolvesandsheepfences") {
				this.drawSheepWolf();
			}
	...
	AnsCheck: {
		checklist: [
			...
			"checkSheepIn@wolvesandsheepfences",
			"checkWolvesOut@wolvesandsheepfences"
		],
	...
	"ImageTile@wolvesandsheepfences": {
		imgsrc_dataurl:
